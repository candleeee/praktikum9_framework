        ...
        <div class="table-responsive border p-3 rounded-3">
            <table class="table table-bordered table-hover table-striped mb-0 bg-white">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex">
                                    ...
                                    <a href="{{ route('employees.edit', ['id' => $employee->employee_id]) }}" class="btn btn-outline-dark btn-sm me-2"><i class="bi-pencil-square"></i></a>
                ...
                <tbody>
                    ...
                    {{-- ACTIONS SECTION --}}
                    <div class="d-flex">
                        <a href="{{ route('employees.edit', ['id' => $employee->id]) }}" class="btn btn-outline-dark btn-sm me-2"><i class="bi-pencil-square"></i></a>
